...
a short walk. The city provides its citizens with 
a Walk Generating App on their phones -- everytime 
you press the button it sends you an array of 
...
def is_valid_walk(walk):
    ...
    if len(walk) != 10:
        ...
        return True if (ups + downs + left + right) == 0 else False
        
print(is_valid_walk(['n','s','n','s','n','s','n','s','n','s']), 'should return True')
print()
print(not is_valid_walk(['w','e','w','e','w','e','w','e','w','e','w','e']), 'should return False')
print()
print(is_valid_walk(['w']), 'should return False')
print()
print(not is_valid_walk(['n','n','n','s','n','s','n','s','n','s']), 'should return False')
print()