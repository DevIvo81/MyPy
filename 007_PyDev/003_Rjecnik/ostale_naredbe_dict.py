...
print('ID\tTip\t\tProizvođač\tRegistracija\t Prva Reg.\tCijena (EUR)')
print('______________________________________'*2)

auti = {1 : '1\tKamion\t\tIveco\t\tOS 001 ZZ\t2015\t\t45.000', 
        2:  '1\tKamion\t\tIveco\t\tOS 002 ZZ\t2015\t\t47.000', 
        3 : '1\tTegljač\t\tMAN\t\tRI 001 ZZ\t2015\t\t78.000', 
        4 : '1\tTegljač\t\tMAN\t\tRI 001 ZZ\t2015\t\t97.000', 
        5 : '1\tKombi\t\tMercedes\tST 001 ZZ\t2015\t\t12.000', 
        6 : '1\tKombi\t\tVolkswagen\tST 001 ZZ\t2015\t\t35.000', 
        7 : '1\tDostavno\tVolkswagen\tZG 001 ZZ\t2015\t\t9.000', 
        8 : '1\tDostavno\tVolkswagen\tZG 001 ZZ\t2015\t\t9.000'}
